        ...
        <form className="space-y-12" >
          <div className="space-y-4">
            <div>
              ...
              <input value={form.phoneNo} onChange={(e) => setForm({ ...form, mobile: e.target.value })} type="number" name="phoneNo" placeholder="+880" className="w-full px-3 py-2 border rounded-md border-gray-300 bg-black text-black font-medium" />
            </div>
